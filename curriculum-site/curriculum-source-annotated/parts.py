...
def _journal(c):
    return (f'<rect x="14" y="8" width="34" height="30" rx="2" fill="#fffbeb" stroke="#d6bb6f" stroke-width="1.5"/>'
            f'<line x1="20" y1="8" x2="20" y2="38" stroke="#fca5a5" stroke-width="1"/>'
            f'<line x1="24" y1="16" x2="43" y2="16" stroke="{GY}" stroke-width="1.2"/>'
            f'<line x1="24" y1="22" x2="43" y2="22" stroke="{GY}" stroke-width="1.2"/>'
            f'<line x1="24" y1="28" x2="38" y2="28" stroke="{GY}" stroke-width="1.2"/>')
def _timer(c):
...
ICONS = {
    ...
    # ---- classroom
    "laptop":     ("Laptop + mBlock", "CLASS", _laptop),
    ...
    "journal":    ("Engineering journal", "CLASS", _journal),
    ...
    "robot_arm":  ("Ranger, assembled", "ROVER", _robot("arm")),
}
