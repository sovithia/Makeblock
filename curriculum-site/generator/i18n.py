...
STRINGS = {
    ...
    "en": {
        ...
        "assessment_title": "Teacher assessment — after the lesson",
        "assessment_student": "Student",
        "assessment_team": "Team",
        "assessment_date": "Date",
        "assessment_instruction": "Circle one score per row from today’s observable evidence. Use N/O when there was no fair opportunity to observe it.",
        "assessment_scale": "1 = needs frequent support · 2 = developing with some support · 3 = secure and independent · 4 = transfers learning or supports others",
        "assessment_criterion": "Criterion",
        "assessment_evidence": "What to look for",
        "assessment_no": "N/O",
        "assessment_understanding": "Understanding",
        "assessment_understanding_evidence": "Explains the main idea, predicts behavior, and answers why—not only what.",
        "assessment_practical": "Practical problem-solving",
        "assessment_practical_evidence": "Builds or codes carefully, tests, uses evidence, and improves after a problem.",
        "assessment_collaboration": "Helpfulness & collaboration",
        "assessment_collaboration_evidence": "Listens, shares work, asks useful questions, and helps without taking over.",
        "assessment_engagement": "Engagement & attitude",
        "assessment_engagement_evidence": "Starts, persists, responds to feedback, and treats people and equipment responsibly.",
        "assessment_total": "Total",
        "assessment_total_note": "4 points per observed criterion",
        "assessment_overall": "Overall",
        "assessment_support": "needs support",
        "assessment_developing": "developing",
        "assessment_secure": "secure",
        "assessment_strong": "strong",
        "assessment_note": "Evidence / one next step",
    ...
    "km": {
        ...
        "assessment_title": "ការវាយតម្លៃរបស់គ្រូ — ក្រោយមេរៀន",
        "assessment_student": "សិស្ស",
        "assessment_team": "ក្រុម",
        "assessment_date": "កាលបរិច្ឆេទ",
        "assessment_instruction": "គូសរង្វង់ពិន្ទុមួយក្នុងមួយជួរ ដោយផ្អែកលើភស្តុតាងដែលបានឃើញថ្ងៃនេះ។ ប្រើ N/O បើគ្មានឱកាសសមរម្យដើម្បីសង្កេត។",
        "assessment_scale": "១ = ត្រូវការជំនួយញឹកញាប់ · ២ = កំពុងអភិវឌ្ឍដោយមានជំនួយខ្លះ · ៣ = យល់ច្បាស់ និងធ្វើដោយឯករាជ្យ · ៤ = អនុវត្តទៅស្ថានភាពថ្មី ឬជួយអ្នកដទៃ",
        "assessment_criterion": "លក្ខណៈវិនិច្ឆ័យ",
        "assessment_evidence": "អ្វីដែលត្រូវមើល",
        "assessment_no": "N/O",
        "assessment_understanding": "ការយល់ដឹង",
        "assessment_understanding_evidence": "ពន្យល់គំនិតសំខាន់ ទស្សន៍ទាយអាកប្បកិរិយា និងឆ្លើយថាហេតុអ្វី មិនមែនតែអ្វី។",
        "assessment_practical": "ការដោះស្រាយបញ្ហាជាក់ស្ដែង",
        "assessment_practical_evidence": "សាងសង់ ឬសរសេរកូដដោយប្រុងប្រយ័ត្ន សាកល្បង ប្រើភស្តុតាង និងកែលម្អក្រោយមានបញ្ហា។",
        "assessment_collaboration": "ការជួយ និងសហការ",
        "assessment_collaboration_evidence": "ស្ដាប់ ចែករំលែកការងារ សួរសំណួរមានប្រយោជន៍ និងជួយដោយមិនដណ្ដើមធ្វើទាំងអស់។",
        "assessment_engagement": "ការចូលរួម និងឥរិយាបថ",
        "assessment_engagement_evidence": "ចាប់ផ្ដើម ព្យាយាមបន្ត ទទួលយកមតិយោបល់ និងគោរពមនុស្សនិងឧបករណ៍។",
        "assessment_total": "ពិន្ទុសរុប",
        "assessment_total_note": "៤ ពិន្ទុសម្រាប់លក្ខណៈវិនិច្ឆ័យនីមួយៗដែលបានសង្កេត",
        "assessment_overall": "កម្រិតសរុប",
        "assessment_support": "ត្រូវការជំនួយ",
        "assessment_developing": "កំពុងអភិវឌ្ឍ",
        "assessment_secure": "យល់ច្បាស់",
        "assessment_strong": "ល្អខ្លាំង",
        "assessment_note": "ភស្តុតាង / ជំហានបន្ទាប់មួយ",
