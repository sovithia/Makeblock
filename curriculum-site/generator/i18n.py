...
STRINGS = {
    ...
    "en": {
        ...
        "forty_line": "◆ The taught course and all four gates end here, inside 40 hours. Stage E below is the capstone — it teaches no new block, so a 40-hour timetable can stop at this line.",
    ...
    "km": {
        ...
        "forty_line": "◆ មេរៀនសំខាន់ និងច្រកត្រួតពិនិត្យទាំងបួន បញ្ចប់ត្រឹមនេះ ក្នុងរយៈពេលក្រោម ៤០ ម៉ោង។ ដំណាក់កាល E ខាងក្រោមជាគម្រោងបញ្ចប់ — គ្មានប្លុកថ្មី ដូច្នេះកម្មវិធី ៤០ ម៉ោង អាចឈប់ត្រឹមបន្ទាត់នេះ។",
